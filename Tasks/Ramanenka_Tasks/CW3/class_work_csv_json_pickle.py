...
with open('audi_a4.csv', "r") as f:
    ...
    # print(type(res))
    # print(res)
with open("audi_a4.json", "w") as f_js:
    json.dump(res, f_js)
with open("audi_a4.pick", "wb") as f_pick:
